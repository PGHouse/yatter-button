...
Router::connect('/bridge/add_yatter',     array('controller' => 'Bridges', 'action' => 'addYatter'));
Router::connect('/bridge/select_yatter',  array('controller' => 'Bridges', 'action' => 'selectYatter'));
